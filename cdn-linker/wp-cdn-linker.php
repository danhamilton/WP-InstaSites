...
class CDNLinksRewriterWordpress extends CDNLinksRewriter
{
	...
	public function register_as_output_buffer() {
		if (($this->blog_url != get_option('bapi_site_cdn_domain'))&&!(is_admin()||is_super_admin())&&(strpos($_SERVER['HTTP_HOST'],'imbookingsecure.com') == false)&&(strpos($_SERVER['HTTP_HOST'],'lodgingcloud.com') == false)) {
