...
class kigo_I18n {
	...
	public static function save_custom_translations() {
		...
		if( !self::update_i18n_customized_translation( array( $_POST['lang_code'] => $array_i18n_overwritten ) ) ) {
	...
	private static function get_i18n_site_array( $lang_code ) {
		...
		if(
			...
			!is_array( self::$array_i18n_overwritten[ $lang_code ] )
		) {
			...
			if(
				...
				!is_array( self::$array_i18n_overwritten[ $lang_code ] = array_diff_assoc( $old_customized_translations, $default_translations ) ) ||
