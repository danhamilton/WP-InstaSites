<?php
	...
	/**
	 * Class Kigo_App_Admin_Bar
	 * Render the Kigo toolbar linking to the App functionalities.
	 * 
	...
	class Kigo_App_Admin_Bar {
		...
		public static $kigo_app_nodes = array(
	...
	if( is_newapp_website() ) {
		...
		add_action( 'admin_bar_menu', array( 'Kigo_App_Admin_Bar', 'register_admin_bar_node' ), 999 );
	}
